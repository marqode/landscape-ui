...
Create a file matching `*.integration.spec.ts` anywhere under `e2e/docker-stack/ui/`.

```ts
// e2e/docker-stack/ui/my-feature/my-feature.integration.spec.ts
...
```ts
// e2e/docker-stack/ui/routing/my-guard.saas.integration.spec.ts
import { test, expect } from "@playwright/test";
